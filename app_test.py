...
def detect():
	...
	if file:
		...
		# Global Variable to be retrieve by Android App
		global_chord = chord_names
		print("global_chord is:", global_chord)

		return jsonify({'chords': chord_names})

		# return jsonify({'chords': "C:maj"})
# End chord detection
...
# Ping Responder for IP Address

@app.route('/ping')
def ping():
	# ip_address = get_ip_address()
	return jsonify({'ip': "fetched"})

# End of Ping Responder for IP Address
